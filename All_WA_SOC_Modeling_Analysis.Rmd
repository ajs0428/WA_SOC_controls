...
```{r}
ggplot(rf_dat, aes(x = (SOC_stock_spline), y = (rf.all), colour = WIP)) +
...
ggplot(test.wetscale, aes(x = (SOC_stock_spline), y = rf.wet.test, colour = MAP)) +
  geom_point(, show.legend = F) + 
  geom_abline(slope = 1, intercept = 0) + 
  geom_smooth(method = "lm", show.legend = F) +
  xlim(0,4) + 
...
ggplot(test.uplscale, aes(x = (SOC_stock_spline), y = rf.upl.test, colour = MAP)) +
  geom_point(, show.legend = F) + 
  geom_abline(slope = 1, intercept = 0) + 
  geom_smooth(method = "lm", show.legend = F) +
  xlim(0,4) + 
